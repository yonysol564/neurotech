...
?>
<div class="home_section_two" style="background-image: url( <?php echo $sec_two_img['url']; ?>);">
	<div class="inner_div">
		...
		<div class="wrap_divs">
			<div class="mid_div" style="background-image: url( <?php echo $image_box_1['url']; ?>);">
				...
				<div class="read_more_div">
					<a href="<?php echo $link_box_1; ?>" title="">Read More >></a>
				</div>
			</div>
			...
			<div class="four_div" style="background-image: url( <?php echo $box_two_image['url']; ?>);">
				...
				<div class="read_more_div">
					<a href="<?php echo $box_two_link; ?>" title="">Read More >></a>
				</div>
			</div>
		</div>
